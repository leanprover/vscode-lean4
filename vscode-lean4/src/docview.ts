...
export class DocViewProvider implements Disposable {
    ...
    async fetch(url?: string): Promise<string> {
        if (url) {
            ...
            const books : any = {
                'Theorem Proving in Lean': mkCommandUri('lean4.docView.openUrl', 'https://leanprover.github.io/theorem_proving_in_lean4/introduction.html'),
                'Mathematics in Lean': mkCommandUri('lean4.docView.openUrl', 'https://leanprover-community.github.io/mathematics_in_lean/'),
                'Reference Manual': mkCommandUri('lean4.docView.openUrl', 'https://leanprover.github.io/lean4/doc/'),
