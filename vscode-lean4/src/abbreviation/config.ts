...
export class AbbreviationConfig {
    ...
    readonly inputModeCustomTranslations = new VsCodeSetting('lean4.input.customTranslations', {
        serializer: serializerWithDefault<SymbolsByAbbreviation>({}),
    })

    readonly eagerReplacementEnabled = new VsCodeSetting('lean4.input.eagerReplacementEnabled', {
        serializer: serializerWithDefault(true),
    })
}
