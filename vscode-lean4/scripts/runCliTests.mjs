...
// Retry params mirror `test/helpers/fs.ts` — see the comment there for the
// Windows PE-image / Defender lock race rationale. The .mjs scripts can't
// import .ts helpers, so the option blob is duplicated.
