...
import { CLIENT_READY_MS, DIAGS_TIMEOUT_MS } from '../helpers/timeouts'

// Non-mathlib project-init behaviours. The mathlib variants
// (`createMathlibProject`, `clone`) sit under the network label because they
...
describe('Project initialization commands', function () {
    ...
    // + an `#eval` round-trip. With the toolchain pre-installed nothing here
    // is genuinely slow, but lake's per-shellout overhead adds up on Windows.
